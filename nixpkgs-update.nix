...
, hex, hpack, hspec, hspec-discover, http-client-tls, http-conduit
, iso8601-time, lifted-base, mtl, neat-interpolation
, optparse-applicative, parsec, parsers, partial-order, polysemy
, polysemy-plugin, raw-strings-qq, regex-applicative-text, servant
, servant-client, sqlite-simple, stdenv, template-haskell
...
mkDerivation {
  ...
  testHaskellDepends = [
    aeson base bytestring conduit containers cryptohash-sha256
    directory doctest errors filepath github hex hspec hspec-discover
    http-client-tls http-conduit iso8601-time lifted-base mtl
    neat-interpolation optparse-applicative parsec parsers
    partial-order polysemy polysemy-plugin raw-strings-qq
